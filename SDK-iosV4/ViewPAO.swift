...
@objc class ViewPAO  {
    ...
    func loadURL ()->NSURLRequest {
        ...
        _url = "?site="+WebPAO._site+"&page="+WebPAO._page+"&pos="+WebPAO._position+"&versdk="+_version+"&device="+device+"&iOsvers="+sistem+"&query="+escaped
